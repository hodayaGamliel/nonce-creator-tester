...
// @LINE:55
private[this] lazy val controllers_Nonce1_throwExcep7042_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Nonce1"))))
private[this] lazy val controllers_Nonce1_throwExcep7042_invoker = createInvoker(
controllers.Nonce1.throwExcep70,
HandlerDef(this.getClass.getClassLoader, "", "controllers.Nonce1", "throwExcep70", Nil,"GET", """""", Routes.prefix + """Nonce1"""))
        

// @LINE:56
private[this] lazy val controllers_Nonce1_throwExcep7043_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("faq"))))
private[this] lazy val controllers_Nonce1_throwExcep7043_invoker = createInvoker(
controllers.Nonce1.throwExcep70,
HandlerDef(this.getClass.getClassLoader, "", "controllers.Nonce1", "throwExcep70", Nil,"GET", """""", Routes.prefix + """faq"""))
...
// @LINE:55
case controllers_Nonce1_throwExcep7042_route(params) => {
   call { 
        controllers_Nonce1_throwExcep7042_invoker.call(controllers.Nonce1.throwExcep70)
   }
}
        

// @LINE:56
case controllers_Nonce1_throwExcep7043_route(params) => {
   call { 
        controllers_Nonce1_throwExcep7043_invoker.call(controllers.Nonce1.throwExcep70)
   }
}
