...
// @LINE:55
private[this] lazy val controllers_Nonce1_throwExcep142_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Nonce1"))))
private[this] lazy val controllers_Nonce1_throwExcep142_invoker = createInvoker(
controllers.Nonce1.throwExcep1,
HandlerDef(this.getClass.getClassLoader, "", "controllers.Nonce1", "throwExcep1", Nil,"GET", """""", Routes.prefix + """Nonce1"""))
        

// @LINE:56
private[this] lazy val controllers_Nonce1_throwExcep143_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("faq"))))
private[this] lazy val controllers_Nonce1_throwExcep143_invoker = createInvoker(
controllers.Nonce1.throwExcep1,
HandlerDef(this.getClass.getClassLoader, "", "controllers.Nonce1", "throwExcep1", Nil,"GET", """""", Routes.prefix + """faq"""))
...
// @LINE:55
case controllers_Nonce1_throwExcep142_route(params) => {
   call { 
        controllers_Nonce1_throwExcep142_invoker.call(controllers.Nonce1.throwExcep1)
   }
}
        

// @LINE:56
case controllers_Nonce1_throwExcep143_route(params) => {
   call { 
        controllers_Nonce1_throwExcep143_invoker.call(controllers.Nonce1.throwExcep1)
   }
}
